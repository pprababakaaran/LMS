...
<head>
	...
	<title>VCEW Learning Management::Delete Student</title>
</head>
<body>
	<div id="bg">
		<div id="sadrzaj">
				<jsp:include page="../includes/leftnav.jsp"></jsp:include><div id="clanci">
				<h2>Delete Student Accounts</h2></div><br>
				<c:choose>
					<c:when test="${!empty approvedMap}">
						<form method="post" action="/lms/deletestudent.htm" name="deletestudentform">
...
$(document).ready(function() {
		$("#deletebtn").on("click", function(){
			var userIdValue = "";
			for(var i=0; i < document.deletestudentform.userId.length; i++){
				if(document.deletestudentform.userId[i].checked)
					userIdValue +=document.deletestudentform.userId[i].value + "\n";
			}
			if(userIdValue==""){
