...
<head>
	...
	<title>VCEW Learning Management::Approve Staff</title>
</head>
<body>
	<div id="bg">
		<div id="sadrzaj">
				<jsp:include page="../includes/leftnav.jsp"></jsp:include><div id="clanci">
				<h2>Activate Staff Accounts</h2></div><br>
				<c:choose>
					<c:when test="${!empty unApprovedMap}">
						<form method="post" action="/lms/approvestaff.htm" name="approvestaffform">
