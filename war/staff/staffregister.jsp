...
<head>
	...
	<title>VCEW Learning Management::Staff Registration</title>
</head>
<body>
	<div id="bg">
		<div id="sadrzaj">
			...
			<div style="text-align: center;"><h3>Staff Registration</h3></div>
			...
			<form:form method="Post" action="/lms/registration.htm" commandName="registration">
					<table style="width:738px">
						...
						<tr><td colspan="3"  height="13"></td></tr>
						<tr>
							<td colspan="2" align="center"><button class="popupbtn" id="registerbtn">Register</button></td>
						</tr>
						<tr><td colspan="3"  height="13"></td></tr>
					</table>
				</form:form>
