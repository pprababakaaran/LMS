...
@Controller
@RequestMapping("/lms/deletestaff")
public class DeleteStaffCallController {
	
	private ProvideApprovalManager approveMgr = new ProvideApprovalManager();
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(method = RequestMethod.POST)
	public String deleteStaff(HttpServletRequest request, HttpServletResponse response,Map model) {
